...
public class ParticipantController {
    ...
    @DeleteMapping("/leave")
    public ResponseEntity<String> delete(@RequestBody ParticipantEventIdRequest participantEventIdRequest, @CookieValue("Authorization") String encodedJwt) {
        participantService.delete(participantEventIdRequest, jwtService.getUserIdByNotParsedToken(encodedJwt));
